            ...
            <table className="w-full">
              ...
              <tbody>
                {contacts.map((contact, index) => (
                  ...
                  >
                    <td className="px-8 py-6 text-xs md:text-lg font-medium">{contact.title}</td>
                    <td className="px-8 py-6 text-xs md:text-lg">{contact.name}</td>
                    <td className="px-8 py-6 text-xs md:text-lg">
                      <a
