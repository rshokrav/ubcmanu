  ...
  return (
    <section className="w-full">
      ...
      <div className="bg-[#F6F0E4] px-4 md:px-6 text-center bg-card py-8 md:py-16 my-3">
        <h1 className="text-3xl md:text-5xl lg:text-7xl text-black leading-tight mb-2 md:mb-4 font-extrabold">
          Manufacturing Engineering
          <br />
          Undergrad Student Society
        </h1>
        <p className="text-sm md:text-base lg:text-lg text-black/80 mt-3 md:mt-6">At the University of British Columbia — Vancouver</p>
      </div>
      ...
      <div className="relative w-full h-[500px] md:h-[600px] lg:h-[700px]">
        ...
        */}
        ...
        <div className="absolute inset-0 flex items-center justify-center px-4 md:px-6">
          <h2 className="font-serif text-2xl md:text-4xl lg:text-5xl xl:text-6xl text-[#FFFFFF] text-center leading-tight text-balance">
