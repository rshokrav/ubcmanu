...
export function HeroSection() {
  return (
    <section className="w-full">
      ...
      <div className="bg-[#F6F0E4] px-6 text-center bg-card py-16 my-3">
        <h1 className="lg:text-7xl text-black leading-tight mb-4 text-5xl font-extrabold">
          Manufacturing Engineering
          <br />
          Undergrad Student Society
        </h1>
        <p className="text-base md:text-lg text-black/80 mt-6">At the University of British Columbia — Vancouver</p>
      </div>
      ...
      <div className="relative w-full h-[500px] md:h-[600px] lg:h-[700px]">
        ...
        */}
        ...
        <div className="absolute inset-0 flex items-center justify-center px-6">
          <h2 className="font-serif text-4xl md:text-5xl lg:text-6xl xl:text-7xl text-[#FFFFFF] text-center leading-tight text-balance">
