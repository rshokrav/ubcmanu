  ...
  return (
    <section className="bg-[var(--off-white)] py-8 md:py-16 px-4 md:px-6 lg:px-24 text-card-foreground bg-popover rounded-none">
      <div className="max-w-7xl mx-auto bg-card">
        <h2 className="text-2xl md:text-4xl lg:text-5xl font-bold mb-4 md:mb-8">Upcoming Events</h2>
        ...
        <div className="space-y-4 md:space-y-6">
          {events.map((event, index) => (
            ...
            >
              <h3 className="text-base md:text-xl lg:text-2xl font-medium">{event}</h3>
            </Link>
          ))}
        </div>
      </div>
